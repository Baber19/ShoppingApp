...
import 'package:shopping_app/screens/onboarding_screen/Widgets/OnBoardText.dart';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    OnBoardText(
                        textData:
                            "Your holiday shopping delivered to Screen ${topBar[index]}"),
                    Padding(
                      padding: const EdgeInsets.only(left: 20),
                      child: SvgPicture.asset("lib/assets/images/Emoji.svg"),
                    ),
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: Text(
                          ...
                          style: const TextStyle(
                              color: Color(0xffB2BBCE), fontSize: 18),
                        ),
                      ),
                    ),
                    SizedBox(
                        ...
                        children: [
                          Container(
                            ...
                            color: index == 0
                                ...
                                : const Color(0xffF8F9FB).withOpacity(0.23),
                          ),
                          Container(
                            margin: const EdgeInsets.only(right: 5),
                            height: 2,
